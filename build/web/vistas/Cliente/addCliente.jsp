<%-- 
    Document   : addCliente
    Created on : 10-nov-2020, 23:18:09
    Author     : LisetSaldana
--%>
        ...
        <div class="container">
            <div class="col-lg-6">
                ...
                <form action="ClienteControlador">
                    ...
                    <input class="form-control" type="text" name="dui"><br>
                    <label for="dir">DIRECCION: </label> <br>
                    <input class="form-control" type="text" name="dir"><br>
                    <label for="tel">TELEFONO: </label> <br>
                    <input class="form-control" type="text" name="tel"><br>
                   
                    <input class="btn btn-primary" type="submit" name="accion" value="AgregarCliente">
